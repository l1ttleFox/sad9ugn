...
**Ключевые материалы:** [управленческая записка](docs/УПРАВЛЕНЧЕСКАЯ_ЗАПИСКА.md) · [резюме 1 стр. BASE vs STRESS](docs/note/RESUME_1page.md) · [презентация PowerPoint (12 слайдов)](presentation/output/Топливный_космоконтур_2035_v2.pptx) · [сценарий выступления](presentation/СЦЕНАРИЙ_ВЫСТУПЛЕНИЯ.md) · [исходник Marp](presentation/presentation.md) · [реестр рисков](results/risk_register.md) · [инструкция оператору](docs/ИНСТРУКЦИЯ.md) · [источники](docs/ИСТОЧНИКИ.md)
...
presentation/      — презентация ≤12 слайдов (финальный PPTX + Marp + PDF/HTML),
